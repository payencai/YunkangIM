...
public class RecordChildAdapter extends BaseQuickAdapter<Order.OrderProductsBean, BaseViewHolder> {
    public RecordChildAdapter(int layoutResId, @Nullable List<Order.OrderProductsBean> data) {
