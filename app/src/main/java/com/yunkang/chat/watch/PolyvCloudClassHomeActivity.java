package com.yunkang.chat.watch;
...
import com.yunkang.chat.study.fragment.RebackFragment;
import com.yunkang.chat.watch.chat.PolyvChatBaseFragment;
import com.yunkang.chat.watch.chat.PolyvChatFragmentAdapter;
import com.yunkang.chat.watch.chat.PolyvChatGroupFragment;
import com.yunkang.chat.watch.chat.PolyvChatPrivateFragment;
import com.yunkang.chat.watch.linkMic.widget.IPolyvRotateBaseView;
import com.yunkang.chat.watch.player.PolyvCloudClassMediaController;
import com.yunkang.chat.watch.player.PolyvCloudClassVideoHelper;
import com.yunkang.chat.watch.player.PolyvCloudClassVideoItem;
import com.yunkang.chat.watch.player.PolyvOrientoinListener;
...
public class PolyvCloudClassHomeActivity extends PolyvBaseActivity
    ...
    private RelativeLayout rebackChatItemLayout;
    ...
    public static void startActivityForLive(Activity activity, String channelId, String userId, boolean isNormalLive,String photo,String name) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!TextUtils.isEmpty(name)){
            ...
            tv_publisher.setText(name.split(",")[1]);
        }
    ...
    private void initialChatRoom() {
        ...
        rebackChatItemLayout=findViewById(R.id.rl_reback);
        ...
        if (playMode == PolyvPlayOption.PLAYMODE_LIVE) {//直播
            ...
            rebackChatItemLayout.setOnClickListener(this);
            ...
            fragments.add(RebackFragment.newInstance(channelId,photo));
...
//        linkMicLayoutParent.resetFloatViewPort();
    ...
    private void loginChatRoom() {
        ...
        String studentUserId = "" + MyApplication.getUserInfo().getId();
        String studentNickName = MyApplication.getUserInfo().getNickName();
        Log.e("studentname",studentNickName);
        chatManager.login(studentUserId, channelId, studentNickName,MyApplication.getUserInfo().getHeadPortrait());
    }
