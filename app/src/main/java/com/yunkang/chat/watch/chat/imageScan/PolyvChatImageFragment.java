package com.yunkang.chat.watch.chat.imageScan;
...
public class PolyvChatImageFragment extends PolyvBaseFragment {
    ...
    @Override
    public int layoutId() {
        return com.easefun.polyv.commonui.R.layout.polyv_fragment_chat_image;
    }
    ...
    public void loadDataAhead() {
        cpvImgLoading = findViewById(com.easefun.polyv.commonui.R.id.cpv_img_loading);
        ivChatImg = findViewById(com.easefun.polyv.commonui.R.id.iv_chat_img);
        ...
        if (imgUrl != null) {
            ...
            Glide.with(this)
                    .load(imgUrl)
                    .apply(new RequestOptions().error(com.easefun.polyv.commonui.R.drawable.polyv_image_load_err).transform(new CompressTransformation(getContext(), imgUrl)))
