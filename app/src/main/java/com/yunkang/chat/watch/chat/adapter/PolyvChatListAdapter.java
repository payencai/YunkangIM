package com.yunkang.chat.watch.chat.adapter;
...
public class PolyvChatListAdapter extends PolyvBaseRecyclerViewAdapter {
    ...
    public class ReceiveMessageHolder extends PolyvBaseRecyclerViewAdapter.ClickableViewHolder {
        ...
        public ReceiveMessageHolder(View itemView) {
            super(itemView);
            avatar = $(com.easefun.polyv.commonui.R.id.iv_avatar);
            type = $(com.easefun.polyv.commonui.R.id.tv_type);
            nick = $(com.easefun.polyv.commonui.R.id.tv_nick);
    ...
    public ClickableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case ChatTypeItem.TYPE_TIPS:
                clickableViewHolder = new TipsMessageHolder(LayoutInflater.from(getContext()).inflate(com.easefun.polyv.commonui.R.layout.polyv_chat_tips_message_item, parent, false));
                break;
            case ChatTypeItem.TYPE_SEND:
                clickableViewHolder = new SendMessageHolder(LayoutInflater.from(getContext()).inflate(com.easefun.polyv.commonui.R.layout.polyv_chat_send_message_item, parent, false));
                break;
            case ChatTypeItem.TYPE_RECEIVE:
                clickableViewHolder = new ReceiveMessageHolder(LayoutInflater.from(getContext()).inflate(com.easefun.polyv.commonui.R.layout.polyv_chat_receive_message_item, parent, false));
                break;
        }
