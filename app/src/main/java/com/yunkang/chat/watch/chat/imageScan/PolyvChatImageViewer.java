...
public class PolyvChatImageViewer extends FrameLayout {
    ...
    private void init(Context context) {
        view = LayoutInflater.from(context).inflate(com.easefun.polyv.commonui.R.layout.polyv_image_viewpager, this);
        vpImageViewer = view.findViewById(com.easefun.polyv.commonui.R.id.vp_image_viewer);
        tvPage = view.findViewById(com.easefun.polyv.commonui.R.id.tv_page);
        ivDownload = view.findViewById(com.easefun.polyv.commonui.R.id.iv_download);
