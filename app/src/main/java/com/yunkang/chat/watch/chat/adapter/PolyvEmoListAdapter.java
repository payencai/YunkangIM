...
public class PolyvEmoListAdapter extends PolyvBaseRecyclerViewAdapter {
    ...
    public class EmoItemViewHolder extends PolyvBaseRecyclerViewAdapter.ClickableViewHolder {
        ...
        public EmoItemViewHolder(View itemView) {
            super(itemView);
            emo = $(com.easefun.polyv.commonui.R.id.iv_emo);
        }
    }
    ...
    public ClickableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new EmoItemViewHolder(LayoutInflater.from(getContext()).inflate(com.easefun.polyv.commonui.R.layout.polyv_chat_emo_item, parent, false));
    }
