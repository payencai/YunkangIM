...
import com.yunkang.chat.watch.chat.adapter.PolyvChatListAdapter;
...
public class PolyvChatGroupFragment extends PolyvChatBaseFragment {
    ...
    @Override
    public int layoutId() {
        return com.easefun.polyv.commonui.R.layout.polyv_fragment_groupchat;
    }
    ...
    private void initView() {
        //下拉控件
        chatPullLoad = findViewById(com.easefun.polyv.commonui.R.id.chat_pull_load);
        ...
        //状态ui
        bgStatus = findViewById(com.easefun.polyv.commonui.R.id.tv_status);
        //只看讲师
        onlyHostSwitch = findViewById(com.easefun.polyv.commonui.R.id.iv_switch);
        ...
        //送花(实则为聊天室的点赞)
        flower = findViewById(com.easefun.polyv.commonui.R.id.iv_flower);
        ...
        //点赞
        liv_like = findViewById(com.easefun.polyv.commonui.R.id.liv_like);
        like = findViewById(com.easefun.polyv.commonui.R.id.like);
        ...
        //更多按钮
        more = findViewById(com.easefun.polyv.commonui.R.id.add_more);
        ...
        moreLayout = findViewById(com.easefun.polyv.commonui.R.id.ic_chat_add_more_layout);
        addPopupBottom(more);
        addPopupLayout(moreLayout);
        selectPhotoButton = findViewById(com.easefun.polyv.commonui.R.id.select_photo_button);
        ...
        openCameraButton = findViewById(com.easefun.polyv.commonui.R.id.open_camera_button);
        ...
        //公告
        tvGongGao = findViewById(com.easefun.polyv.commonui.R.id.tv_gonggao);

        //欢迎语
        greetingText = findViewById(com.easefun.polyv.commonui.R.id.greeting_text);
    }
    ...
    private Spannable generateLikeSpan(String sendNick) {
        ...
        Drawable drawable = getContext().getResources().getDrawable(com.easefun.polyv.commonui.R.drawable.polyv_gift_flower);
